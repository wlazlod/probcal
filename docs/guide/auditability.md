...
verifies the pack in one process. In a real review the right-hand sides are
numbers printed in the report the reviewer was handed, copied out of its
fingerprint block, and the assertions are the same.
